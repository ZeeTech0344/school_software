    ...
    <div class="col-lg-12 col-sm-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between flex-row-reverse">
                <h6 class="m-0 font-weight-bold text-primary">سٹوڈنٹ کے جانے کی حاضری بذریعہ کیو آر کوڈ</h6>
                <div>
                </div>
            </div>
            <div class="card-body">
...
@section('script')
    <script>
        ...
        function onScanSuccess(decodedText, decodedResult) {
            ...
            var index = sentStudents.indexOf(student_id);

            if (index == -1){
                sentStudents.push(student_id);
            }else{
               return false;
            }
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "{{ url('time-to-go-student-attendance-update') }}",
