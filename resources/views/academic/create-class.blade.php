...
@section('content')
    <div class="col-12 d-flex justify-content-center">
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between flex-row-reverse">
                    <h6 class="m-0 font-weight-bold text-primary">درجہ فارم</h6>
                </div>
                <div class="card-body">
    ...
    <script>
        ...
        $(document).on("click", ".edit_book", function() {
            ...
            $.ajax({
                ...
                url: "{{ url('get-book-for-edit') }}",
                type: "GET",
                data: {
                    id: id
                },
                success: function(data) {
                    var class_tag = $("#book").val(data["book"]);
