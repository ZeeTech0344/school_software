    ...
    <div class="col-lg-12 col-sm-12">
        <div class="card shadow mb-4">
            ...
            {{-- <div class="row p-4">
                ...
                {{-- <div class="col">
                    <select class="form-control toselect-tag" onchange="items(this)" name="items" id="items">
...
{{-- 
                <div>
                    ...
                    <input type="button" value="PDF" class="btn btn-danger" id="get_return_stock_pdf">
                    <input type="button" value="View" class="btn btn-primary" id="get_return_stock_view">
                </div>
            </div> --}}
...
<script>
    ...
    var get_send_stock_list = $('.get_send_stock_list').DataTable({
        ...
        ajax: {
            url: "{{ url('return-stock-report-list') }}",
            data: function(d) {
    ...
    var url = "{{ url('get-return-record-view') }}" + "/" + from_date + "/" + to_date + "/" + items + "/" + branch;

    viewModal(url);

    });

    $("#get_return_stock_pdf").click(function(){
     ...
     $.ajax({
            ...
            url:"{{ url('return-stock-report-pdf') }}",
            type:"POST",
