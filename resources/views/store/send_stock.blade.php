        ...
        <div class="col-lg-4 col-sm-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Send Stock</h6>
                </div>
                <div class="card-body">
                ...
                $.ajax({
                    ...
                    beforeSend: function() {
                       ...
                       if(remaining_stock<0){
                            alert("Your remaining stock is less then actual stock");
                            return false;
                        }else{

                            var confirm_stock =  confirm("Are you sure! Send Stock of " + item_name + " ( " + stock_qty_send + ") to "  + branch);
                            if(!confirm_stock){
                                return false;
                            }
        ...
        $(document).on("click", ".edit_send_stock", function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var current_stock_qty = $("#current_stock_qty").val( (parseInt(data[4]["weight"]) - parseInt(data[3])) + parseInt(data[5])  );
                    var current_stock = $("#current_stock").val( (parseInt(data[4]["weight"]) - parseInt(data[3])) + parseInt(data[5]) );
