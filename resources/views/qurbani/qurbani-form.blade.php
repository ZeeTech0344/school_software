                    ...
                    <form id="qurbani-form">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="qurbani_name" name="qurbani_name"
...
@section('script')
    <script>
        ...
        $(document).on("click", ".edit-qurbani-data", function() {
            ...
            $.ajax({
                ...
                url: "{{ url('update-qurbani-data') }}",
                type: "POST",
                data: {
                    id: id
                },
                success: function(data) {
                   $("#qurbani_name").val(data["qurbani_name"]);
