    ...
    <div class="col-12 d-flex justify-content-center">
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Return Inventory</h6>
                </div>
                <div class="card-body">
                    <form id="send-inventory-form">
                        ...
                        <div class="form-group">
                            <label for="exampleFormControlInput1">Return Quantity</label>
                            <input type="number" class="form-control" id="return_qty" name="return_qty" onkeyup="calculateQty()">
                        </div>
        ...
        <div class="col-lg-6 col-sm-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Return Inventory List</h6>
                    <div>
    ...
    <script>
        ...
        $('#send-inventory-form').validate({
            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    url: "{{ url('insert-return-inventory') }}",
                    type: "POST",
                    data: formData,
                    contentType: false,
                    cache: false,
        ...
        $(document).on("click", ".edit_return_inventory", function() {
