...
<div class="col-12 d-flex justify-content-center">
    ...
    <div class="col-lg-6 col-sm-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between flex-row-reverse">
                <h6 class="m-0 font-weight-bold text-primary"> لاکر اخراجات لسٹ</h6>
                <div>
    ...
    <div class="col-lg-6 col-sm-12">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex justify-content-between flex-row-reverse">
                <h6 class="m-0 font-weight-bold text-primary text-right">لاکر فارم</h6>
            </div>
            <div class="card-body">
...
<script>
   ...
   function refreshTableAfterAdmissionYearLoad(){
    ...
    var easypaisa_paid_list = $('.employee_front_table').DataTable({
        ...
        ajax: {
            url: "{{ url('get-locker-amount-list') }}",
            data: function(d) {
