...
@foreach ($fee_vouchers as $fee_voucher)
    <section style="display:flex; justify-content:center;  align-items: center; margin-bottom:10px;">
        @for ($a = 0; $a < 2; $a++)
            <table>
                <thead>
                     <tr> <th  colspan="3">  <h1 style="text-align: center;  padding:10px; margin:0; margin-top:10px;">جامع تذکیرالقرآن </h1>
                    ...
                    <tr>
                        <th  colspan="3"> طالب علم کا نام/ایڈمیشن نمبر :
                ...
                <tbody>
                    ...
                    @endforeach
                    <tr><td>{{ $fee_voucher['fine'] }}</td><td>فائن</td><td>{{ $sr++ }}</td></tr>
                    <tr><td>  {{ $fee_voucher['before_due_date'] }} </td><td><b> ٹوٹل واجب الادا </b></td> <td> </td> </tr>
                    <tr><td>  {{ $fee_voucher['after_due_date'] }} </td><td><b> (تاریخ کے بعد) ٹوٹل واجب الادا </b></td> <td> </td> </tr>
                    <tr>
                        <td colspan="3"></td>
                     </tr>
                    <tr>
