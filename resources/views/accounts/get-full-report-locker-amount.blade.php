        ...
        <div class="col-lg-4 col-sm-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between flex-row-reverse">
                    <h6 class="m-0 font-weight-bold text-primary"> لاکر اداکردہ لسٹ</h6>
                </div>
                <div class="card-body">
                    <div>
    ...
    <script>
        ...
        $("#get_easypaisa_view").click(function() {
            ...
            if (from_date !== "" && to_date !== "" && type !== "") {
                ...
                var url = "{{ url('get-view-locker-amount-new-created-second') }}" + "/" + from_date + "/" +
                    to_date + "/" + type;
                ...
                var url = "{{ url('view-report-locker-amount') }}" + "/" + from_date + "/" + to_date + "/" +
                    type;
                viewModal(url);
            }
        ...
        $("#get_print").click(function() {
            ...
            if (from_date !== "" && to_date !== "") {
                $.ajax({
                    url: "{{ url('print-view-report-locker-amount') }}" + "/" + from_date + "/" + to_date + "/" + type,
                    type: 'GET',
