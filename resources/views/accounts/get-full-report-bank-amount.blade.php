        ...
        <div class="col-lg-4 col-sm-12">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between flex-row-reverse">
                    <h6 class="m-0 font-weight-bold text-primary"> بینک اداکردہ لسٹ</h6>
                </div>
                <div class="card-body">
                    <div>
...
@section('script')
    <script>
        ...
        $("#get_easypaisa_view").click(function() {
            ...
            var bank_name = $("#bank_name")[0].value;

            if (from_date !== "" && to_date !== "") {
                var url = "{{ url('view-report-bank-amount') }}" + "/" + from_date + "/" + to_date + "/" + bank_name;
                viewModal(url);
            }
        ...
        $("#get_print").click(function() {
            ...
            if (from_date !== "" && to_date !== "") {
                $.ajax({
                    url: "{{ url('view-report-bank-amount') }}" + "/" + from_date + "/" + to_date + "/" + bank_name,
                    type: 'GET',
